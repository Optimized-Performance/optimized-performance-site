...
(function () {
  ...
  const PEPTIDES = [
    ...
    { name: "Glow (BPC + TB-500 + GHK-Cu)", vialMg: 70, bacMl: 2, dose: 2, unit: "mg", freq: "daily", range: "≈2 mg blend / shot — reconstitute the full vial, adjust to your protocol" },
    { name: "Klow (BPC + TB-500 + GHK-Cu + KPV)", vialMg: 80, bacMl: 2, dose: 2, unit: "mg", freq: "daily", range: "≈2 mg blend / shot — reconstitute the full vial, adjust to your protocol" },
    ...
    { name: "NAD+",               vialMg: 500,bacMl: 5, dose: 100, unit: "mg",  freq: "daily",  range: "50–100 mg (often titrated up)" },
    { name: "SS-31 (Elamipretide)",vialMg: 10, bacMl: 2, dose: 5,  unit: "mg",  freq: "daily",  range: "5–10 mg (research varies)" },
    ...
    { name: "KPV",                vialMg: 10, bacMl: 2, dose: 500, unit: "mcg", freq: "daily",  range: "250–500 mcg" },
    { name: "Selank",             vialMg: 10, bacMl: 2, dose: 250, unit: "mcg", freq: "daily",  range: "250–500 mcg" },
    { name: "Semax",              vialMg: 10, bacMl: 2, dose: 300, unit: "mcg", freq: "daily",  range: "200–600 mcg" },
    { name: "Adamax",             vialMg: 5,  bacMl: 2, dose: 500, unit: "mcg", freq: "daily",  range: "250–500 mcg" },
    { name: "DSIP",               vialMg: 10, bacMl: 2, dose: 100, unit: "mcg", freq: "daily",  range: "100–300 mcg (pre-sleep)" },
