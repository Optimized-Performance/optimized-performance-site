...
const faqs = [
  {
    ...
    items: [
      ...
      { q: 'My vial has little or no vacuum — is that a problem?', a: 'No. The amount of vacuum in a lyophilized (freeze-dried) vial varies from vial to vial and can shift with temperature and altitude changes during shipping — some hold a strong vacuum, some hold little or none. Vacuum level is NOT an indicator of quality, potency, or purity, and it has no effect whatsoever on the freeze-dried powder inside. What actually verifies the product is the independent third-party COA (identity + purity) published for every lot at /coa/{sku}/{lot}, plus an intact seal and a clean white-to-off-white powder in the vial. Whether a vial holds a strong vacuum or none at all, the product is unaffected.' },
    ],
  },
  {
    category: 'Ordering',
