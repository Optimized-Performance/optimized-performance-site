const products = [
  ...
  },
  {
    ...
    dosage: '10mg',
    price: 74.95,
    description: 'Semaglutide — GLP-1 receptor agonist peptide. Lyophilized powder for research use.',
    category: 'GLPs',
    format: 'Lyophilized Powder',
    vialSize: '2 mL Vial',
    inStock: false,
  ...
  {
    id: 'sema-10mg-kit',
    sku: 'OP-SEMA-10MG-KIT',
    name: 'Semaglutide Kit (10x10mg)',
    dosage: '100mg total',
    price: 599.95,
    description: '10-vial kit — Semaglutide GLP-1 receptor agonist, 10mg each. Lyophilized powder for research use.',
    category: 'GLPs',
    format: 'Lyophilized Powder',
    vialSize: '10 x 2 mL Vials',
    inStock: false,
