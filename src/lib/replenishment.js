    ...
    for (const c of dueByEmail.values()) {
      try {
        ...
        const bodyLines = [
          ...
          ``,
          `To make the reorder easy, here's ${RECOVERY_DISCOUNT_PCT}% off if you grab it in the`,
          `next ${OFFER_TTL_DAYS} days — it stacks with any affiliate code you use, and the`,
          `discount applies automatically when you click through:`,
          ``,
